...
# tlo gry
background = pygame.image.load(r"C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\galaxy.jpg")
# soundtrack

mixer.music.load(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\soundtrack.wav')
...
icon = pygame.image.load(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\nuke.png')
pygame.display.set_icon(icon)

# gracz
playerImage = pygame.image.load(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\rock.png')
playerX = 370
playerY = 512
playerX_change = 0
# przeciwnik
...
def creating_enemies_tables(number_enemy):
    for e in range(number_enemy):
        enemyImage.append(pygame.image.load(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\spaceship.png'))
...
# strzal
bulletImage = pygame.image.load(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\moon.png')
bulletX = 0
bulletY = 480
bulletX_change = 0
bulletY_change = 10
...
# wynik
score_val = 0
font = pygame.font.Font(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\Pacifico.ttf', 24)

fontX = 5
fontY = 5
# game over
over_font = pygame.font.Font(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\Roboto.ttf', 40)
byetext = pygame.image.load(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\gameover.jpg')
...
def highscore(high):
    with open(r"C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\score_file.txt", "r+") as hisc:
        hi = hisc.read()
...
while running:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state == "ready":
                    bullet_sound = mixer.Sound(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\bulletshot.wav')
                    bullet_sound.play()
                    bulletX = playerX
    ...
    for k in range(number_enemy):
        ...
        if collis:
            boom_sound = mixer.Sound(r'C:\Users\wikto\PycharmProjects\untitled\projekt gry python\projektpygame\mojaGRa\hurt.wav')
            boom_sound.play()
            bullet_state = "ready"
            bulletY = 480
            score_val += 1
